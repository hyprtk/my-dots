...
echo ""
yay -S bibata-cursor-theme waypaper trizen sublime-text-4 sddm-theme-sugar-candy-git pacseek pamac-all libpamac-full pamac-cli tumbler-extra-thumbnailers --noconfirm
echo ""
