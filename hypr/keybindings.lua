...
--
-- =================================================================
-- Keybindings — Hyprland keyboard shortcuts
-- =================================================================
--
...
hl.bind(mainMod .. " + CTRL + Q", hl.dsp.exec_cmd("~/hyprtk/common/hyprlogout/logout.sh"))
...
hl.bind(mainMod .. " + SHIFT + B", hl.dsp.exec_cmd("~/hyprtk/common/waybar/launch.sh"))
...
hl.bind(mainMod .. " + CTRL + T", hl.dsp.exec_cmd("~/hyprtk/common/waybar/themeswitcher.sh"))
